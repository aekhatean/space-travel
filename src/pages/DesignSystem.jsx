  ...
  return (
    <div className="design-system container">
      ...
      <section id="colors">
        ...
        <div className="color-cards flex">
          {/* First section */}
          <div>
            <div
            ...
            <p>
              <span className="txt-light" style={{ float: "left" }}>
                RGB
              </span>
              <span>11, 13, 23</span>
            </p>
        ...
        <div className="flex">
          <div className="flow" style={{ flexBasis: "100%" }}>
            ...
            <div>
              ...
              <p className="txt-light fs-500 ff-sans-cond letter-spacing-1 uppercase">
          ...
          <div className="flow" style={{ flexBasis: "100%" }}>
            ...
            <div>
              <p className="txt-light">Body Text</p>
              <p>
